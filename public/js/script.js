...
// Gửi nhiệm vụ mới lên server để lưu vào MongoDB
  fetch('https://thao225.github.io/ToSoList_NhapGitHub/backend/server.js/api/todo/add', {
      method: 'POST',
...
async function loadTasks() {
    ...
    try {
        const response = await fetch(`https://thao225.github.io/ToSoList_NhapGitHub/backend/server.js/api/todo/list/${userId}`);
        if (!response.ok) {
